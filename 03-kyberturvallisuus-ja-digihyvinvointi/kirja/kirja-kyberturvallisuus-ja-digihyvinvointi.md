...
> 📚 **Lisätietoja — Tietosuoja ja yksityisyys**
>
> - [Tietosuojavaltuutetun toimisto](https://tietosuoja.fi/) — Suomen virallinen tietosuojaviranomainen: oikeutesi, lomakkeet ja ohjeet
> - [Have I Been Pwned?](https://haveibeenpwned.com/) — Tarkista, onko sähköpostiosoitteesi joutunut tietomurtoon
> - [EU — Tietosi verkossa](https://europa.eu/youreurope/citizens/consumers/internet-telecoms/data-protection-online-privacy/index_fi.htm) — EU:n tietosuojaoikeudet kansalaisille
...
> 📚 **Lisätietoja — Kyberturvallisuus**
>
> - [Kyberturvallisuuskeskus](https://www.kyberturvallisuuskeskus.fi/) — Traficomin viranomaissivusto: ajankohtaiset uhat, varoitukset ja toimintaohjeet
> - [Kyberturvallisuuskeskus — Ohjeet kansalaisille](https://www.kyberturvallisuuskeskus.fi/fi/yleisoohjeet) — Käytännön tietoturvavinkit tavalliselle käyttäjälle
> - [Have I Been Pwned?](https://haveibeenpwned.com/) — Tarkista, ovatko salasanasi tai tilisi tiedot vuotaneet
...
> 📚 **Lisätietoja — Sosiaalinen media ja vastuullisuus**
>
